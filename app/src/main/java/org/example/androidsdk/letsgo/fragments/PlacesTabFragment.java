...
public class PlacesTabFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
...
//                Toast.makeText(getActivity(),position+"",Toast.LENGTH_SHORT).show();
                ...
                serverRequest.addToRecent("565fc3e7107e019459c7ef87", placeList.get(position).getEventId(), new GetStringCallback() {
                    @Override
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        filter.setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                Toast.makeText(getActivity(),"Placesfilter",Toast.LENGTH_SHORT).show();
                return false;
            }
        });
